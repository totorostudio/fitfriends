...
type TrainingFilterProps = {
  filter: Filter;
  setFilter: Dispatch<SetStateAction<Filter>>;
};

export function TrainingFilter({ filter, setFilter }: TrainingFilterProps): JSX.Element {
        ...
        <div className="filter-price">
          <div className="filter-price__input-text filter-price__input-text--min">
            <input
              ...
              onChange={(e) => handleInputChange(setFilter, e)}
            />
          ...
          <div className="filter-range__control">
            <input
              ...
              <input
                type="range"
                name="priceTo"
                className="filter-range__max-toggle"
                min="0"
                max="50000"
                value={filter.priceTo}
                onChange={(e) => handleInputChange(setFilter, e)}
      ...
      <div className="my-training-form__block my-training-form__block--calories">
        ...
        <div className="filter-calories">
          <div className="filter-calories__input-text filter-calories__input-text--min">
            <input type="number" id="text-min-cal" name="caloriesFrom" value={filter.caloriesFrom} onChange={(e) => handleInputChange(setFilter, e)} />
            <label htmlFor="text-min-cal">от</label>
          </div>
          <div className="filter-calories__input-text filter-calories__input-text--max">
            <input type="number" id="text-max-cal" name="caloriesTo" value={filter.caloriesTo} onChange={(e) => handleInputChange(setFilter, e)} />
